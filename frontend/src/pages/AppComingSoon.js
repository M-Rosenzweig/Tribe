  ...
  return (
    <div className="MasterAppSoon">
        ...
        <div
          ...
          onClick={() => handleActiveSetter(1)}
        >
          <FaCampground />
        </div>
        <div
          id={active === "Energy" ? "SelectedButton" : ""}
          className="IndividualButton"
          onClick={() => handleActiveSetter(2)}
        >
          <FiCoffee />
        </div>
        <div
          id={active === "Chat" ? "SelectedButton" : ""}
          className="IndividualButton"
          onClick={() => handleActiveSetter(3)}
        >
          <BsChatSquare />
        </div>
        <div
          id={active === "Resources" ? "SelectedButton" : ""}
          className="IndividualButton"
          onClick={() => handleActiveSetter(4)}
        >
          <BsBoxSeam />
        </div>
        <div
          id={active === "Governance" ? "SelectedButton" : ""}
          className="IndividualButton"
          onClick={() => handleActiveSetter(5)}
        >
          <GiCampfire />
        </div>
      </div>
